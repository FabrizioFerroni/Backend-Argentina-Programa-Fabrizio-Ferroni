...
public class DownloadCv {
    ...
    public DownloadCv(int id, String nombre, String apellido, String nombreCv, String FDescarga, String ruta, String nombredown, String email, Integer cv_id, Integer usuario_id, LocalDateTime createdAt) {
        this.id = id;
        this.nombre = nombre;
